...
{% responsive_image path: assets/img/nc_assets/gap-definition.png %} 
{% responsive_image path: assets/img/nc_assets/NC-fig1-v2.png %} 
{% responsive_image path: assets/img/nc_assets/Training_Loop.png %} 
